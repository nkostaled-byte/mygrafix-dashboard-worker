...
export async function executeTool(toolName, args, env, clientId) {
  ...
  if (isWriteTool(toolName)) {
    ...
    return {
      ...
      message: `This ${action.label.toLowerCase()} requires user confirmation via the confirmation buttons the system presents. Present a brief summary of the details; do NOT ask the user to confirm in text.`,
    };
  }
